...
let click={		//new
    ...
    staff_open(link){		//new
		...
		links.click.dell_list.dataset.many='staff_dell';
		links.click.dell_all_list.dataset.many='staff_dell_all';
		blk=links.table.centre_list;
    ...
    user(link){		//new
		console.log('user');
		let blk=links.tables.centre;
		control.on_on(['main_menu', 'clients_menu', 'table_centre', 'list_buttons',  'buttons_line'], link);
		link.dataset.choose=1;
